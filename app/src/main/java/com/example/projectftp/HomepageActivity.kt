...
class HomepageActivity : AppCompatActivity() {
    ...
    private val launcherIntentGallery = registerForActivityResult(ActivityResultContracts.StartActivityForResult()) {
        if (it.resultCode == RESULT_OK) {
            ...
            selectedImage.let { result ->
                val myFile = uriToFile(result, this@HomepageActivity)
                resultViewModel.setFile(myFile)
                photo2 = myFile
            }
        }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        resultViewModel.tempFile.observe(this@HomepageActivity) { file ->
            if(file != null) {
                val i = Intent(this@HomepageActivity, Preview1::class.java)
